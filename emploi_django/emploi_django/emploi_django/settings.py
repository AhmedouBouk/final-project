"""
Django settings for emploi_django project.
...
SECRET_KEY = 'django-insecure-upgp2-e+zr0i#0_+-8l0rdo%2lorq#&#b)-w%1+k+i#mjcz^i1'
...
CORS_ALLOWED_ORIGINS = [
    "http://192.168.101.13"  # Alternate localhost
]
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # Allow all requests during development
    ],
}
