...
urlpatterns = [
    ...
    path('api/departments/<str:department_code>/semesters/', views.get_semesters, name='get_semesters'),
    path('api/schedule/<str:department_code>/<str:semester_code>/<int:week>/', views.get_schedule, name='get_schedule'),
    path('api/bilan/<str:department_code>/<str:semester_code>/', views.get_bilan, name='get_bilan'),
